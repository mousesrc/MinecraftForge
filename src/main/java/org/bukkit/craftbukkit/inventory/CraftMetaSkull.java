...
class CraftMetaSkull extends CraftMetaItem implements SkullMeta {
    ...
    void applyToItem(final NBTTagCompound tag) { // Spigot - make final
        ...
        if (profile != null) {
            ...
            net.minecraft.tileentity.TileEntitySkull.updateGameprofile(profile, new com.google.common.base.Predicate<GameProfile>() {
    ...
    public boolean setOwner(String name) {
        ...
        if (name == null) {
            ...
            // Spigot start
            profile = TileEntitySkull.profileCache.getGameProfileForUsername(name.toLowerCase(java.util.Locale.ROOT));

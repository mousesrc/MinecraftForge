...
public class CraftCrashReport implements ICrashReportDetail<Object> {
    ...
    public Object call() throws Exception {
        ...
        try {
            value.append("\n   Running: ").append(Bukkit.getName()).append(" version ").append(Bukkit.getVersion()).append(" (Implementing API version ").append(Bukkit.getBukkitVersion()).append(") ").append(String.valueOf(((CraftServer)Bukkit.getServer()).getServer().isServerInOnlineMode()));
            value.append("\n   Plugins: {");
            ...
            value.append("\n   Reload Count: ").append(String.valueOf(((CraftServer)Bukkit.getServer()).getServer().server.reloadCount));
            value.append("\n   Threads: {");

...
public class CraftEventFactory {
    ...
    private static boolean canBuild(CraftWorld world, Player player, int x, int z) {
        ...
        if (world.getHandle().provider.getDimension() != 0) return true;
    ...
    public static void handleEditBookEvent(EntityPlayerMP player, ItemStack newBookItem) {
        ...
        PlayerEditBookEvent editBookEvent = new PlayerEditBookEvent((Player) player.getBukkitEntity(), player.inventory.currentItem, (BookMeta) CraftItemStack.getItemMeta(player.inventory.getCurrentItem()), (BookMeta) CraftItemStack.getItemMeta(newBookItem), newBookItem.getItem() == Items.WRITTEN_BOOK);
    ...
    public static Cancellable handleStatisticsIncrease(EntityPlayer entityHuman, net.minecraft.stats.StatBase statistic, int current, int incrementation) {
        Player player = (Player) ((EntityPlayerMP) entityHuman).getBukkitEntity();
        Event event;
    ...
    public static boolean handleBlockFormEvent(World world, BlockPos pos, net.minecraft.block.Block block, @Nullable Entity entity) {

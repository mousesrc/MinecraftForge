...
public class CraftHumanEntity extends CraftLivingEntity implements HumanEntity{
        ...
        switch (type) {
            ...
            case SHULKER_BOX:
                if (iinventory instanceof TileEntityShulkerBox) {
                    getHandle().displayGui((TileEntityShulkerBox) iinventory);
                } else {
    ...
    public InventoryView openEnchanting(Location location, boolean force) {
        ...
        TileEntity container = getHandle().world.getTileEntity(new BlockPos(location.getBlockX(), location.getBlockY(), location.getBlockZ()));
    ...
    public boolean hasCooldown(Material material) {
        ...
        return getHandle().getCooldownTracker().hasCooldown(CraftMagicNumbers.getItem(material)); // PAIL: getCooldownTracker
    }

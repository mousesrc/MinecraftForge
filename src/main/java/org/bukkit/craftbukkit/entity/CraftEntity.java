...
public abstract class CraftEntity implements org.bukkit.entity.Entity {
    ...
    public boolean teleport(Location location, TeleportCause cause) {
        ...
        if (!location.getWorld().equals(getWorld())) {
            entity.getServer().getPlayerList().transferEntityToWorld(entity,entity.getEntityWorld().provider.getDimension(), (WorldServer) entity.getEntityWorld(),((CraftWorld)location.getWorld()).getHandle());
        ...
        entity.setRotationYawHead(location.getYaw()); // PAIL: setHeadRotation
    ...
    public List<org.bukkit.entity.Entity> getNearbyEntities(double x, double y, double z) {
        List<Entity> notchEntityList = entity.world.getEntitiesInAABBexcluding(entity, entity.getEntityBoundingBox().expand(x, y, z), null);
    ...
    public boolean eject() {
        ...
        getHandle().removePassengers(); // PAIL: rename
        return true;
    }
    ...
    public Set<String> getScoreboardTags() {
        return getHandle().getTags(); // PAIL: getScoreboardTags
    }

    @Override
    public boolean addScoreboardTag(String tag) {
        return getHandle().addTag(tag); // PAIL: addScoreboardTag
    }

    @Override
    public boolean removeScoreboardTag(String tag) {
        return getHandle().removeTag(tag); // PAIL: removeScoreboardTag
    }
    ...
    // Spigot start
    public final org.bukkit.entity.Entity.Spigot spigot = new org.bukkit.entity.Entity.Spigot()
    {
        @Override
        public boolean isInvulnerable()
        {

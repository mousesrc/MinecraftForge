...
public final class VanillaCommandWrapper extends VanillaCommand {
    ...
    public List<String> tabComplete(CommandSender sender, String alias, String[] args, Location location) throws IllegalArgumentException {
        ...
        return (List<String>) vanillaCommand.getTabCompletions(((CraftServer)Bukkit.getServer()).getServer(), getListener(sender), args, (location) == null ? null : new BlockPos(location.getX(), location.getY(), location.getZ()));
    }
    ...
    public final int dispatchVanillaCommand(CommandSender bSender, ICommandSender icommandlistener, String[] as) throws CommandException {
        ...
        try {
            ...
            //((CraftServer)Bukkit.getServer()).getServer().worlds = prev;
        }
    ...
    private ICommandSender getListener(CommandSender sender) {
        ...
        if (sender instanceof RemoteConsoleCommandSender) {
            return ((DedicatedServer)((CraftServer)Bukkit.getServer()).getServer()).rconConsoleSource;
        }
